...
public class InstanceofExam{
	public static void main(String args []){
		...
		if(car instanceof Car){ // car 가 Car 타입이 될수있나 -> true
		...
		if(car instanceof EfSonata){ // car가 EfSonata 타입이 될수있나 -> false
		...
		/*
		 * if(p instanceof Car){  // instanceof 연산자는 상속관계일때 사용할수 있다. -> 아예 사용불가
