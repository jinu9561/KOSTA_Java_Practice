...
/////////////////////////////////////////////////////
	...
	public int withdraw(int userSeq, int accountSeq, int withdraw) throws BalanceLackException, UserAccountNotFoundException {
		AccountDto withdrawAccount = getUserAccount(userSeq, accountSeq);
		withdrawAccount.setBalance(withdrawAccount.getBalance() - withdraw);
			
		if(withdrawAccount.getBalance() > 0) return withdrawAccount.getBalance();
		else throw new BalanceLackException();
